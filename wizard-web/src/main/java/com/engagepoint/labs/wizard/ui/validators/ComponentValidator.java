...
public class ComponentValidator implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        switch (question.getQuestionType()) {
            ...
            case CHECKBOX:
                ...
                break;
            case CHOOSEFROMLIST:
                validateDropDownQuestionComponent((HtmlSelectOneMenu) component, value);
                break;
        }
    }

    private void validateDropDownQuestionComponent(HtmlSelectOneMenu component, Object value) {
    ...
    private void validateTextAreaQuestionComponent(InputTextarea component, Object value) {
        if (question.isRequired()) {
            if (value == null) {
                question.setValid(false);
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Validation Error",
